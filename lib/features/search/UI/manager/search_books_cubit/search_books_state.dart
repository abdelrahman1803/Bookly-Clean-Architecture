...
final class SearchBooksHistoryLoading extends SearchBooksState {}

final class SearchBooksHistorySuccess extends SearchBooksState {
  final List<BookEntity> bookHistory;

  SearchBooksHistorySuccess(this.bookHistory);
}
